...
STATIC connector_bool_t rci_action_session_start(rci_t * const rci, rci_service_data_t * service_data)
{
    ...
    trigger_rci_callback(rci, connector_request_id_remote_config_session_start, connector_false);
...
{
    trigger_rci_callback(rci, connector_request_id_remote_config_session_cancel, connector_false);
    {
