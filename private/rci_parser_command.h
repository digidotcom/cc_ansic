...
static connector_bool_t is_query_command(rci_command_t const command);
static connector_bool_t is_set_command(rci_command_t const command)
{
    connector_bool_t const is_set = connector_bool((command == rci_command_set_setting) || (command == rci_command_set_state));
...
static connector_bool_t is_query_command(rci_command_t const command)
{
    connector_bool_t const is_query = connector_bool((command == rci_command_query_setting) || (command == rci_command_query_state));
