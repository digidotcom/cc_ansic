...
static connector_bool_t have_attribute(rci_attribute_t * const attribute)
{
    return connector_bool(rcistr_valid(attribute_name(attribute)) && rcistr_valid(attribute_value(attribute)));
}
