...
#if (defined CONNECTOR_DATA_SERVICE) || (defined CONNECTOR_FILE_SYSTEM) || (defined CONNECTOR_RCI_SERVICE) || (defined CONNECTOR_STREAMING_CLI_SERVICE) || (defined SM_CONFIGURATION)
