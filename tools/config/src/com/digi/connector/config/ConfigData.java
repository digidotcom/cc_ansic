...
public class ConfigData {
    ...
    private ConfigData() {
        ...
        globalFatalProtocolErrors.put("invalid_index", "Invalid index");
		globalFatalProtocolErrors.put("invalid_name", "Invalid name");
		globalFatalProtocolErrors.put("missing_name", "Missing name");
