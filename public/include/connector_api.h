...
#if ((defined CONNECTOR_TRANSPORT_TCP) + (defined CONNECTOR_TRANSPORT_UDP) + (defined CONNECTOR_TRANSPORT_SMS) >  1)
#define CONNECTOR_MULTIPLE_TRANSPORTS
#endif
...
typedef enum {
    ...
    connector_class_id_streaming_message    /**< Streaming message service Class ID */
...
#include "api/connector_api_streaming_cli.h"
