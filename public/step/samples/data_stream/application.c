...
int application_step(connector_handle_t handle)
{
    ...
    static unsigned long time_interval_in_seconds = 2;
    ...
    if (next_send_time < current_time)
    {
        ...
        case connector_success:
            next_send_time = current_time + time_interval_in_seconds;
            if (time_interval_in_seconds < 60)
                time_interval_in_seconds += 2;
            break;
