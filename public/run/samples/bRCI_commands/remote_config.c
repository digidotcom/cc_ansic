...
char CONST connector_remote_all_strings[] = {
 ...
 11,'R','e','b','o','o','t',' ','f','a','i','l',
 15,'D','o',' ','C','o','m','m','a','n','d',' ','f','a','i','l',
 24,'S','e','t',' ','F','a','c','t','o','r','y',' ','D','e','f','a','u','l','t',' ','f','a','i','l'
};
...
static char const * const connector_rci_errors[] = {
 ...
 CONNECTOR_GLOBAL_ERROR_REBOOT_FAIL, /*reboot_fail*/
 CONNECTOR_GLOBAL_ERROR_DO_COMMAND_FAIL, /*do_command_fail*/
 CONNECTOR_GLOBAL_ERROR_SET_FACTORY_DEFAULT_FAIL /*set_factory_default_fail*/
};
