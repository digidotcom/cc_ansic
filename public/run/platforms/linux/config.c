...
{
    config_connect->status = connector_connect_auto;
    return connector_callback_continue;
}
...
static connector_callback_status_t app_start_network_sms(connector_config_connect_status_t * const config_connect)
{
    config_connect->status = connector_connect_auto;
    return connector_callback_continue;
}
