...
#define BOOTLOADER_ENABLED 1
#define IDIGI_MAC_ADDRESS { 0x00, 0x04, 0x9f, 0x01, 0x59, 0x14 }
#define IDIGI_DEFAULT_MAC_ADDRESS { 0x00, 0x04, 0x9f, 0x01, 0x59, 0x14 }
#define IDIGI_DEVICE_IPADDR     0x0A3412D2  
#define IDIGI_DEVICE_IPMASK     0xFFFFFF00
#define IDIGI_DEVICE_GATEWAY    0x0A341201 
#define IDIGI_DNS_SERVER_IPADDR 0x0A34013E 
// #define IDIGI_USE_STATIC_IP
