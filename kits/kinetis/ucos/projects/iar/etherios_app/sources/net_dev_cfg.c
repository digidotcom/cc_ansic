...
const  NET_DEV_CFG_ETHER  NetDev_Cfg_KxxN512_0 = {
    ...
    NET_DEV_CFG_FLAG_NONE,          /* Desired option flags, if any (see Note #6).                                      */
             ...
             8u,                    /* Desired number of device's receive  descriptors (see Note #7).                   */
             5u,                    /* Desired number of device's transmit descriptors.                                 */


    0x400C0000u,                    /* Base address   of device's hardware/registers.                                   */
...
const  NET_PHY_CFG_ETHER  NetPhy_Cfg_0 = {
...
/*
*********************************************************************************************************
*                                  EXAMPLE PPP DEVICE CONFIGURATION
*********************************************************************************************************
*/

#ifdef  NET_IF_MODULE_PPP_PRESENT   /* #### NOT yet implemented.                                                        */

                                    /* -------------------- EXAMPLE PPP DEVICE B, #1 CONFIGURATION -------------------- */

const  NET_DEV_CFG_PPP  NetDev_Cfg_B_1 = {

    NET_IF_MEM_TYPE_DEDICATED,      /* Desired receive  buffer memory pool type :                                       */
                                    /*   NET_IF_MEM_TYPE_MAIN        buffers allocated from main memory                 */
                                    /*   NET_IF_MEM_TYPE_DEDICATED   buffers allocated from (device's) dedicated memory */
     1500,                          /* Desired size      of device's large receive  buffers (in octets) [see Note #2].  */
      10u,                          /* Desired number    of device's large receive  buffers             [see Note #3a]. */
       4u,                          /* Desired alignment of device's       receive  buffers (in octets) [see Note #4].  */
       0u,                          /* Desired offset from base receive  index, if needed   (in octets) [see Note #5a]. */
    ...
    NET_DEV_CFG_FLAG_NONE,          /* Desired option flags, if any (see Note #6).                                      */
                                    ...
                                    /* #### Additional PPP configuration to be determined.                              */

};


#endif                              /* End of PPP device configuration.                                                 */
