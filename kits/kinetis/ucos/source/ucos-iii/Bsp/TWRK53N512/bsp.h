...
#define  BSP_LED_ORANGE                      1                  /* Orange LED at PTC7.                                  */
#define  BSP_LED_YELLOW                      2                  /* Yellow LED at PTC8.                                  */

#define  BSP_PB_START                        0                  /* Push button at SW6 (start button).                   */
#define  BSP_PB_STOP                         1                  /* Push button at SW7 (stop  button).                   */

#define  BSP_STATUS_MAX_CHECKS              10                  /* Maximum number of reads in order to avoid bouncing.  */
#define  BSP_STATUS_CHECK_INTERVAL           5                  /* Interval time to read the inputs to avoid bouncing.  */

#define  BSP_OPAMP_MODULE_0                  0                  /* OPAMP module number.                                 */
#define  BSP_OPAMP_MODULE_1                  1                  /* OPAMP module number.                                 */

#define  BSP_OPAMP_MODE_BUFFER               0                  /* OPAMP function mode/                                 */
#define  BSP_OPAMP_MODE_INVERTING            1                  /* OPAMP function mode/                                 */
#define  BSP_OPAMP_MODE_GENERAL              2                  /* OPAMP function mode/                                 */
#define  BSP_OPAMP_MODE_NON_INVERTING        3                  /* OPAMP function mode/                                 */

#define  BSP_OPAMP_GAIN_TBL_IX_MIN           0                  /* OPAMP gain table min index.                          */
#define  BSP_OPAMP_GAIN_TBL_IX_MAX          16                  /* OPAMP gain table max index.                          */
...
#define  BSP_CLOCK_MUL                     (24)                 /* BSP_CORE_CLOCK = 48MHz                               */
...
#define  BSP_GPIOA_PIN_10                    DEF_BIT_10         /* LED Blue   @ D17 in the schematics.                  */
#define  BSP_GPIOA_PIN_11                    DEF_BIT_11         /* LED Orange @ D16 in the schematics.                  */
...
#define  BSP_GPIOA_PIN_28                    DEF_BIT_28         /* LED Yellow @ D15 in the schematics.                  */
#define  BSP_GPIOA_PIN_29                    DEF_BIT_29         /* LED Green  @ D14 in the schematics.                  */

#define  BSP_GPIO_LEDS                      (BSP_GPIOC_LED_ORANGE | \
...
#define  BSP_GPIOC_PB_START                  DEF_BIT_05
#define  BSP_GPIOC_PIN_06                    DEF_BIT_06
#define  BSP_GPIOC_LED_ORANGE                DEF_BIT_07
#define  BSP_GPIOC_LED_YELLOW                DEF_BIT_08
...
#define  BSP_GPIOC_PB_STOP                   DEF_BIT_13
...
void         BSP_OPAMP_Init              (CPU_INT08U, CPU_INT08U, CPU_INT08U);
...
/*
*********************************************************************************************************
*                                     BLOOD PRESSURE MONITOR SERVICES
*********************************************************************************************************
*/

void         BSP_BPM_CloseValve           (CPU_INT08U);
...
static const    CPU_INT08U BSP_OPAMP_GainTbl[] = {0x02, 0x01, 0x03, 0x08, 0x0A, 0x09, 0x0B, 0x04, 0x06, 0x05, 0x07, 0x0C, 0x0E, 0x0D, 0x0F, 0x1D, 0x3F};
