 ...
 * 
 * - If @ref device_id_method is set to @ref connector_device_id_method_auto then:
 *   - If @ref connection_type is set to @ref connector_connection_type_lan, from the @ref mac_address.
 *   - If @ref connection_type is set to @ref connector_connection_type_wan then:
 ...
 * 
 * - If @ref device_id_method is set to @ref connector_device_id_method_manual then:
