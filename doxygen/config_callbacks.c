 ...
 * 
 * - If @ref connection_type is set to @ref connector_device_id_method_auto:
 *   - If @ref connection_type is set to @ref connector_connection_type_lan: From the MAC address @ref mac_address.
 *   - If @ref connection_type is set to @ref connector_connection_type_wan:
 *     - If @ref wan_type is set to @ref connector_wan_type_esn: From the ESN @ref esn_number.
 *     - If @ref wan_type is set to @ref connector_wan_type_meid: From the ESN @ref meid_number.
 *     - If @ref wan_type is set to @ref connector_wan_type_imei: From the ESN @ref imei_number.
 * 
 * - If @ref connection_type is set to @ref connector_device_id_method_manual:
 *   - Function @ref get_device_id will be called, if a buffer set to 0 is returned, then Cloud Connector will ask Device Cloud for an autogenerated 
 * Device ID (auto-provisioning) and will call @ref set_device_id to save it for future starts. Else, if the buffer is not 0x00, that Device ID will be used.
 * 
