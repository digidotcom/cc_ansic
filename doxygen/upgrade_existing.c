 ...
 *
 * There are two ways of upgrading an existing application from previous version 2.0.1.x to current 2.1.0.x:
 ...
 *
 * Version 2.1.0.x not only fixes known bugs but also adds new features like the Device ID autoprovisioning, posibility of
