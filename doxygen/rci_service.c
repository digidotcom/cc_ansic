 ...
 *     {
 *         response->error_id = connector_global_error_no_memory;
 *         goto done;
 *     }
 *
 *     session_ptr = ptr;
 ...
 *                   @endhtmlonly @ref connector_element_value_type_t @htmlonly
 *            </dd>
 *            <dt><i>value</i></dt>
 *            <dd> - the pointer to @endhtmlonly @ref connector_element_value_t @htmlonly
 ...
 *                <dd> - contains a signed integer number for @endhtmlonly @ref connector_element_type_int32 @htmlonly type.
 *                </dd>
 ...
 *                <dd> - contains a floating point value for @endhtmlonly @ref connector_element_type_float @htmlonly type.
 *                </dd>
 *                <dt><i>enum_value</i></dt>
 *                <dd> - contains an enumeration value (generated by the RCI tool) for @endhtmlonly @ref connector_element_type_enum @htmlonly type.
 *                </dd>
 *                <dt><i>on_off_value</i></dt>
 *                <dd> - contains <b>connector_on</b> or <b>connector_off</b> value for @endhtmlonly @ref connector_element_type_on_off @htmlonly type.
 *                </dd>
 *                <dt><i>boolean_value</i></dt>
 *                <dd> - contains <b>connector_boolean_true</b> or <b>connector_boolean_false</b> value
 *                     for @endhtmlonly @ref connector_element_type_boolean @htmlonly type.
 *                </dd>
 *              </dl>
 *            </dd>
 *          </dl>
 ...
 *          <dl>
 *              <dt><i>action</i></dt>
 *              <dd> - the @endhtmlonly @ref connector_remote_action_query @htmlonly to query device configurations. </dd>
 *              <dt><i>group</i></dt>
 *              <dd><dl>
 *                  <dt><i>type</i></dt>
 *                  <dd><ul><li>@endhtmlonly @ref connector_remote_group_setting @htmlonly for setting configuration group or </li>
 ...
 *     <dt><i>element_data</i></dt>
 *     <dd>
 *       - the pointer to @endhtmlonly @ref connector_remote_element_response_t @htmlonly
 *       where callback writes response data to either error_hint or element_value:
 *       <dl>
 *                  <dt><i>error_hint</i></dt>
 *                  <dd> - Callback returns a pointer to a constant null-terminated hint string
 *                         which will be sent to the server if error is encountered. error_id is set.
 *                         This string cannot be altered until next callback call.
 *                         Note: This must be set to NULL for no hint string when error_id is set.</dd>
 *                  <dt><i>element_value</i></dt><dd> - the pointer to @endhtmlonly @ref connector_element_value_t @htmlonly
 ...
 *                              <ul> <li>@endhtmlonly @ref connector_element_type_string @htmlonly</li>
 *                                   <li>@endhtmlonly @ref connector_element_type_multiline_string @htmlonly</li>
 *                                   <li>@endhtmlonly @ref connector_element_type_password @htmlonly</li>
 *                                   <li>@endhtmlonly @ref connector_element_type_ipv4 @htmlonly</li>
 *                                   <li>@endhtmlonly @ref connector_element_type_fqdnv4 @htmlonly</li>
 *                                   <li>@endhtmlonly @ref connector_element_type_fqdnv6 @htmlonly</li>
 *                                   <li>@endhtmlonly @ref connector_element_type_datetime @htmlonly</li></ul></dd>
 *                          <dt><i>integer_signed_value</i></dt>
 ...
 *                               <ul><li>@endhtmlonly @ref connector_element_type_uint32 @htmlonly</li>
 *                                   <li>@endhtmlonly @ref connector_element_type_hex32 @htmlonly</li>
 *                                   <li>@endhtmlonly @ref connector_element_type_0x_hex32 @htmlonly</li></ul></dd>
 *                          <dt><i>float_value</i></dt>
 *                          <dd> - Callback writes a floating point value for @endhtmlonly @ref connector_element_type_float @htmlonly type.</dd>
 *                          <dt><i>enum_value</i></dt>
 *                          <dd> - Callback writes an enumeration value (generated by the RCI tool) for @endhtmlonly @ref connector_element_type_enum @htmlonly type.</dd>
 *                          <dt><i>on_off_value</i></dt>
 *                          <dd> - Callback wrties <b>connector_on</b> or <b>connector_off</b> value for @endhtmlonly @ref connector_element_type_on_off @htmlonly type.</dd>
 *                          <dt><i>boolean_value</i></dt>
 *                          <dd> - Callback writes <b>connector_boolean_true</b> or <b>connector_boolean_false</b> value
 *                                 for @endhtmlonly @ref connector_element_type_boolean @htmlonly type.</dd></dl></dd>
 *                 </dl></dd>
 *            </dl>
 * </td></tr>
 * <tr>
 ...
 * <tr>
 * <th>request_id</th>
 * <td>@endhtmlonly @ref connector_remote_config_group_end @htmlonly</td>
 * </tr>
 * <tr>
 * <th>request_data</th>
 * <td> [IN] Pointer to @endhtmlonly @ref connector_remote_group_request_t "Remote configuration request" @htmlonly
 ...
 * <tr>
 * <th>request_id</th>
 * <td>@endhtmlonly @ref connector_remote_config_action_end @htmlonly</td>
 * </tr>
 * <tr>
 * <th>request_data</th>
 * <td> [IN] Pointer to @endhtmlonly @ref connector_remote_group_request_t "Remote configuration request" @htmlonly
 ...
 * <tr>
 * <th>request_id</th>
 * <td>@endhtmlonly @ref connector_remote_config_session_cancel @htmlonly</td>
 * </tr>
 * <tr>
 * <th>request_data</th>
