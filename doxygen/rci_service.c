 ...
 *         <dd>&nbsp;&nbsp;this field can be set to 'connector_rci_config_not_available' to force Cloud Connector to ignore this group. 
 ...
 *                      <li>attribute.compare_to is different than @endhtmlonly @ref rci_query_setting_attribute_compare_to_none.@htmlonly</li></ul></dd> 
 *         <dd>&nbsp;&nbsp;this field can be set to 'connector_rci_config_not_available' to force Cloud Connector to ignore this element. 
