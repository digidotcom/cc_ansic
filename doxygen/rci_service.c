 ...
 *  -# Etherios Cloud Connector calls application-defined @ref rci_session_start callback to start remote configuration request.
 *  -# Etherios Cloud Connector calls application-defined @ref rci_action_start callback to start setting or querying remote configuration.
 *  -# Etherios Cloud Connector calls application-defined @ref rci_group_start callback to start each configuration group.
 *  -# Etherios Cloud Connector calls application-defined:
 ...
 *  -# Etherios Cloud Connector calls application-defined @ref rci_group_end callback after all requested elements
 *     of the configuration group are processed.
 *  -# Etherios Cloud Connector calls application-defined @ref rci_action_end callback when it's done setting or querying all requested
 *     configuration groups.
 *  -# Etherios Cloud Connector calls application-defined @ref rci_session_end callback to end remote configuration request.
 *
 *
 * @note Etherios Cloud Connector calls step 3 to 5 repeatedly for each configuration group.
 ...
 * to cancel remote configuration request and Etherios Cloud Connector sends an error response to Etherios Device Cloud.
 * If Etherios Cloud Connector encounters error, it calls application-defined @ref rci_session_cancel callback
 ...
 *                     error is encountered. Etherios Cloud Connector sends error description if it's provided for the given error_id.</dd>
 *         <dt><i>response</i></dt>
 *         <dd><dl>
 *             <dt><i>error_hint</i></dt>
 *             <dd> - Callback returns a pointer to a constant null-terminated hint string
 *                    which will be sent to Etherios Device Cloud if error is encountered.
 ...
 *
 * Callback is called indicating whether Etherios Cloud Connector starts setting or querying remote configuration
 *
 * @htmlonly
 * <table class="apitable">
 * <tr> <th colspan="2" class="title">Arguments</th> </tr>
 ...
 *                 <dl><dt><i>string_value</i></dt>
 *                     <dd> - Callback returns a pointer to a NUL-termianted data string for the following types:
 *                        <ul>
 *                          <li>@endhtmlonly @ref connector_element_type_string @htmlonly</li>
 *                          <li>@endhtmlonly @ref connector_element_type_multiline_string @htmlonly</li>
 *                          <li>@endhtmlonly @ref connector_element_type_password @htmlonly</li>
 ...
 *
 * Callback is called indicating Etherios Cloud Connector is done processing a configuration group.
 ...
 *
 * Callback is called indicating Etherios Cloud Connector is done setting or querying device configuration.
