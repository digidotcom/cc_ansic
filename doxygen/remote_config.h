...
/**
 * @defgroup connector_on_off_t  iDigi Connector on or off values
 * @{
 */
/**
...
/**
* @defgroup connector_boolean_t iDigi Connector boolean type
* @{
*/
/**
* Boolean type
*/
typedef enum {
    connector_boolean_false,    /**< False */
    connector_boolean_true      /**< True */
} connector_boolean_t;
/**
* @}
*/
...
/**
 * @defgroup connector_element_value_type_t iDigi Connector remote configuration element types
 * @{
 */
/**
 ...
 */
typedef enum {
    connector_element_type_string,              /**< Single line string */
    ...
    connector_element_type_0x_hex32,               /**< 32-bit unsigned hexadecimal with 0x prefix shown in the iDigi Device Cloud.*/
    ...
    connector_element_type_on_off,              /**< "on" or "off" value. An applciation's callback should use
    ...
    connector_element_type_ipv4,                /**< Valid IPv4 address (32-bit value) which is shown aaa.bbb.ccc.ddd in the iDigi Device Cloud */
    ...
    connector_element_type_datetime             /**< Date and time type. It’s string which contains the ISO 8601 standard
...
/**
 * @defgroup connector_element_value_t iDigi Connector remote configuration element value union
 * @{
 */
/**
...
typedef union {
    ...
    connector_boolean_t boolean_value;      /**< @ref connector_boolean_true for true or @ref connector_boolean_false for false value for @ref connector_element_type_boolean value type */
