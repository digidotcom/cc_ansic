...
static bool parse_cmd_line(int argc, char **argv, app_config_t * const config)
{
        ...
        )
    {
        ...
        APP_PRINTF("<iDigi Device Cloud Server URL> -  my.idigi.com or my.idigi.co.uk\n\n"); 
        ...
        APP_PRINTF("<MAC Address> - MAC address of the device, used to identify the device to the iDigi Device Cloud,\n");
