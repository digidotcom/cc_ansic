                                            ...
                                            void * response_data, size_t * const response_length)
{
    ...
    case connector_network_open:
        status = app_network_connect((char *)request_data, request_length, (connector_network_handle_t **)response_data);
        *response_length = sizeof(connector_network_handle_t);
        break;

    case connector_network_send:
        status = app_network_send((connector_write_request_t *)request_data, (size_t *)response_data);
        break;

    case connector_network_receive:
        status = app_network_receive((connector_read_request_t *)request_data, (size_t *)response_data);
        break;
    ...
    default:
        APP_DEBUG("connector_network_callback: unrecognized callback request [%d]\n", request);
