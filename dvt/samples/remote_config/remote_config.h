 ...
 * This file was generated on: 2014/07/10 17:37:38 
...
typedef enum {
 connector_setting_device_stats_curtime,
 connector_setting_device_stats_signed_integer,
 connector_setting_device_stats_COUNT
} connector_setting_device_stats_id_t;
...
typedef enum {
 ...
 connector_setting_device_info_syspwd,
 connector_setting_device_info_COUNT
} connector_setting_device_info_id_t;

typedef enum {
 connector_setting_device_info_error_bad_command = 1, /* Protocol defined */
 connector_setting_device_info_error_bad_descriptor,
 connector_setting_device_info_error_load_fail, /* User defined (global errors) */
 connector_setting_device_info_error_save_fail,
 connector_setting_device_info_error_memory_fail,
 connector_setting_device_info_error_invalid_length,  /* User defined (group errors)*/
 connector_setting_device_info_error_COUNT
...
typedef enum {
 ...
 connector_setting_state_test_test4,
 connector_setting_state_test_test5,
 connector_setting_state_test_test6,
 connector_setting_state_test_test7,
 connector_setting_state_test_test8,
 connector_setting_state_test_test9,
 connector_setting_state_test_test10,
 connector_setting_state_test_test11,
 connector_setting_state_test_test12,
 connector_setting_state_test_test13,
 connector_setting_state_test_test14,
 connector_setting_state_test_test15,
 connector_setting_state_test_COUNT
} connector_setting_state_test_id_t;
...
typedef enum {
 connector_state_debug_info_version,
 connector_state_debug_info_stacksize,
 connector_state_debug_info_COUNT
} connector_state_debug_info_id_t;
...
typedef enum {
 connector_state_gps_stats_error_bad_command = 1, /* Protocol defined */
 connector_state_gps_stats_error_bad_descriptor,
 connector_state_gps_stats_error_load_fail, /* User defined (global errors) */
 connector_state_gps_stats_error_save_fail,
 connector_state_gps_stats_error_memory_fail,
 connector_state_gps_stats_error_invalid_lat,  /* User defined (group errors)*/
 connector_state_gps_stats_error_invalid_long,
 connector_state_gps_stats_error_COUNT
} connector_state_gps_stats_error_id_t;
